...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="150">
                                ...
                                <a href="{{ url('cashier-delete-processbill-row-item',$items->id) }}" onclick="return confirm ('Are you sure to Delete')">
            ...
            <br>
            <form action="{{ url('cashier-save-billhistory')}} " method="post">
                @csrf
                <div class="container">
                    <div class="row">
                        <div class="col-sm">
